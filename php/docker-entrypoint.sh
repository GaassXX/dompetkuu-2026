...
# Step 2: If .env file doesn't exist, create with predefined values
...
# Step 7: Initialize project (fresh migrations + seed + shield) — only once
if [ ! -f /var/www/html/storage/.initialized ]; then
  echo "🚀 Running project:init..."
  php artisan project:init || echo "⚠️ project:init encountered an issue"
