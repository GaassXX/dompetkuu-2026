        ...
        <div class="grid lg:grid-cols-2 gap-10 items-start">
            ...
            <div class="relative z-10 max-w-lg">
                ...
                <h1 class="text-2xl lg:text-[1.85rem] font-extrabold text-gray-900 leading-snug mb-2">
                    Buat akun baru di <span class="text-[#0D9488]">dompettkuu</span>
                </h1>
                ...
                <form method="POST" action="{{ route('auth.register.post') }}">
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-5">
                        ...
                        <label class="cursor-pointer block">
                            ...
                            <div class="relative flex items-center gap-3 border-2 border-gray-200 peer-checked:border-teal-500 peer-checked:bg-teal-50/60 rounded-2xl p-3 transition hover:border-teal-300">
                                <div class="w-5 h-5 rounded-full bg-teal-500 flex items-center justify-center absolute top-2 right-2 check-icon hidden">
                                ...
                                <div class="w-11 h-11 rounded-full flex items-center justify-center flex-shrink-0" style="background:linear-gradient(135deg,#a7f3d0,#6ee7b7);">
                                    <svg class="w-5.5 h-5.5 text-teal-700" fill="currentColor" viewBox="0 0 24 24" style="width:22px;height:22px;">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" value="{{ old('name', $google_name ?? '') }}"
                            ...
                            class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl text-sm placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-teal-400 transition {{ $errors->has('name') ? 'border-red-400' : '' }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" name="email" value="{{ old('email', $google_email ?? '') }}"
                            ...
                            class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl text-sm placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-teal-400 transition {{ $errors->has('email') ? 'border-red-400' : '' }}"
                            required {{ $google_email ? 'readonly' : '' }}>
                        @if($google_email)
                        <p class="text-teal-600 text-xs mt-1 flex items-center gap-1">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" id="password" name="password" placeholder="Min 8 karakter"
                                    class="w-full px-4 py-3 pr-9 bg-white border border-gray-200 rounded-xl text-sm placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-teal-400 transition {{ $errors->has('password') ? 'border-red-400' : '' }}"
                                    required>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Ulangi sandi"
                                    class="w-full px-4 py-3 pr-9 bg-white border border-gray-200 rounded-xl text-sm placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-teal-400 transition"
                                    required>
                ...
                <div class="mt-5 bg-gray-50 border border-gray-100 rounded-2xl px-4 py-3.5 flex items-center justify-between">
                    <span class="text-xs text-gray-500">
                        Sudah punya akun?
                        <a href="{{ route('auth.login') }}" class="text-teal-600 font-bold hover:underline">Masuk di sini</a>
                    </span>
                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
