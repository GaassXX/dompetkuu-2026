...
use App\Filament\Parent\Resources\SavingResource\Pages;
...
class SavingResource extends Resource
{
    ...
    // ✅ Parent hanya lihat tabungan diri sendiri + anak
    public static function getEloquentQuery(): Builder
    {
        ...
        return parent::getEloquentQuery()->whereIn('user_id', $allIds);
    }
            ...
            Forms\Components\Section::make()
                ...
                ->schema([
                    Forms\Components\TextInput::make('name')
                        ->label('Nama Tabungan')
                        ->placeholder('e.g. Liburan ke Jepang')
                    ...
                    Forms\Components\Textarea::make('description')
                        ->label('Deskripsi')
                        ->placeholder('Tuliskan catatan atau detail lainnya mengenai tabungan ini...')
                        ->columnSpanFull(),
                ])
                ->columns(2),
        ]);
