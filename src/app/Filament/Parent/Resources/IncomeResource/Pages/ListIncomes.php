...
namespace App\Filament\Parent\Resources\IncomeResource\Pages;

use App\Filament\Parent\Resources\IncomeResource;
...
class ListIncomes extends Page
{
    ...
    protected static string $view     = 'filament.parent.resources.income-resource.pages.list-incomes';
